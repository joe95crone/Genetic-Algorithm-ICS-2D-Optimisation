...
y = np.loadtxt('run/var_output.txt')
f = np.loadtxt('run/pareto.500')
...
ax1.set_title(r"GA NRB Opt: 200 gen., 32 ind. per gen.", size=14)
ax1.grid(axis='both')
...
ax2.set_title(r"GA NRB Opt: 200 gen., 32 ind. per gen.", size=14)
ax2.grid(axis='both')
