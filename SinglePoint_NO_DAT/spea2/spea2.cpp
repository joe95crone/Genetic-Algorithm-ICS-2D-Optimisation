...
char dump_state_buf[128];
#define DUMP_STATE(n) { sprintf(dump_state_buf, "Entering state %d\n", n); \
    msg_to_file(diag_file, dump_state_buf); } (void)0
